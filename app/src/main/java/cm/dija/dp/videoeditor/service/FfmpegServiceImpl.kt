...
import cm.dija.dp.videoeditor.repository.ProcessRepository
...
class FfmpegServiceImpl : FfmpegService {
    ...
    {
        var outputPath = Environment.getExternalStorageDirectory().path + "/" + "Mp4Editor" + "/" + exportedFileName + ".mp4"
    ...
    private fun ffmpegExecute(ctx: Context, args: Array<String>, outputPath: String) {
        ...
        progressDialog.setIcon(cm.dija.dp.videoeditor.R.drawable.export_video)
